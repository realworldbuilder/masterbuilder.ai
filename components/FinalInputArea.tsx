  ...
  return (
    ...
    >
      ...
      <button
        disabled={disabled}
        type="submit"
        className="relative ml-3 flex size-[72px] shrink-0 items-center justify-center rounded-md bg-orange-gradient disabled:pointer-events-none disabled:opacity-75"
      >
        {disabled && (
